...
abstract class AppLocalizations {
  ...
  /// No description provided for @addRemoveCity.
  ///
  /// In en, this message translates to:
  /// **'Add / Remove City'**
  ...
  /// No description provided for @compactLayoutSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Reduce padding and card heights'**
  String get compactLayoutSubtitle;
  ...
  /// No description provided for @currentCities.
  ///
  /// In en, this message translates to:
  /// **'Current Cities'**
  String get currentCities;
